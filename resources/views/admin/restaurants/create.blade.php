            ...
            <div class="card border-0 mb-5 w-75">
                <div class="card-body shadow p-3">
                    ...
                    <div class="form-group d-flex flex-column w-100">
                        ...
                        <input class="form-check form-font" type="text" class="form-control" name="city" placeholder="City" value="{{old('city')}}" required maxlength="20">
                        {{-- SHOWING ERROR MESSAGE --}}
                        @error('city')
                            <div class="alert alert-danger">
                                {{ $message }}
                    ...
                    <div class="form-group d-flex flex-column w-100">
                        ...
                        <input class="form-check form-font" type="text" class="form-control" name="address" placeholder="Full address" value="{{old('address')}}" required maxlength="50">
                        {{-- SHOWING ERROR MESSAGE --}}
                        @error('address')
                            <div class="alert alert-danger">
                                {{ $message }}
