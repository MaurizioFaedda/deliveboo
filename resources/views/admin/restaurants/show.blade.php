                ...
                <div class="card no-border border-radius-top shadow">
                    ...
                    <form class="d-flex flex-column align-items-left py-3 px-3" action="{{route('admin.dishes.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group d-flex flex-column align-items-left w-100">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Write your dish name here" value="{{old('name')}}" maxlength="100" required>
                        ...
                        <div class="form-group d-flex flex-column align-items-left w-100">
                            ...
                            <textarea class="form-control" name="infos" maxlength="250">{{old('infos')}}</textarea>
                            {{-- SHOWING ERROR MESSAGE --}}
                            @error('infos')
                                <div class="alert alert-danger">
                                    {{ $message }}
                        ...
                        <div class="form-group d-flex flex-column align-items-left w-100">
                            ...
                            <input id="input-language" class="pl-1" type="file" class="form-control-file" name="image" accept="image/*">
                        </div>
                        <div class="form-group d-flex flex-column align-items-left w-100">
