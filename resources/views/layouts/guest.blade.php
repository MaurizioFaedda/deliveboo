                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                            ...
                            <ul class="list-unstyled mb-0">
                                <li>
                                    <a href="https://www.linkedin.com/in/marco-caputo-58000a1ab/" class="footer-font-color nunito">Marco Caputo</a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/maurizio-faedda/" class="footer-font-color nunito">Maurizio Faedda</a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/patriziacrimi/" class="footer-font-color nunito">Patrizia Crimi</a>
                                </li>
                            </ul>
                        </div>
                        <!--Grid column-->
                        ...
                        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a href="https://www.linkedin.com/in/annalisa-de-santis-annalisadesantis1991/" class="footer-font-color nunito">Annalisa De Santis</a>
                                </li>
                                <li>
